...
candledaily:([] sym:`$();time:`timestamp$(); open:`float$();high:`float$();low:`float$();close:`float$();volume:`float$());
candlehourly:([] sym:`$();time:`timestamp$(); open:`float$();high:`float$();low:`float$();close:`float$();volume:`float$());
candleminutely:([] sym:`$();time:`timestamp$(); open:`float$();high:`float$();low:`float$();close:`float$();volume:`float$());
...
CanInfo: 0N! .j.k .Q.hg ":https://api.cryptowat.ch/markets/coinbase-pro/btcusd/ohlc?periods=86400";
...
CanInfo: 0N! .j.k .Q.hg ":https://api.cryptowat.ch/markets/coinbase-pro/btcusd/ohlc?periods=14400";
...
CanInfo: 0N! .j.k .Q.hg ":https://api.cryptowat.ch/markets/coinbase-pro/btcusd/ohlc?periods=900";
